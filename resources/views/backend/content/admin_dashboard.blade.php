...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Earnings Overview ( {{$startWeek}} - {{$endWeek}}) </h6>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4" style="min-height:410px">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    @if(count($topThreeConcerts) == 0)
                    <p style="text-align: center">No concerts found</p>
                    @else
                    @foreach($topThreeConcerts as $index => $concert)
                    <div class="row mt-1">
                        <div class="col-md-12">
                            <h6 class="font-weight-bold"> <i
                                    class="bi @if($index == 0) bi-1-circle-fill text-primary @elseif($index == 1) bi-2-circle-fill text-success @elseif($index == 2) bi-3-circle-fill text-danger @endif"></i>
                                {{$concert->concert_name}} - {{$concert->total_seats_sold}} pcs</h6>
                        </div>
                    </div>
                    @endforeach
                    @endif
